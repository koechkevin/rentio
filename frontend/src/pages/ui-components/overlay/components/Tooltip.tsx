...
const Link = ({ id, children, title }: LinkProps) => (
...
function TooltipExample() {
  return (
    <p>
      ...
      terry richardson vinyl chambray. Beard stumptown, cardigans banh mi lomo thundercats. Tofu biodiesel williamsburg
...
export const tooltipExampleCode = `import { OverlayTrigger, Tooltip } from "react-bootstrap";
